...
const recommendationsItem = { name: 'Recommendations', view: 'recommendations', id: 6 };
    ...
    return (
      <ul className="side-menu-container">
        ...
        <MenuItem
          ...
          title={recommendationsItem.name}
          active={this.state.active === recommendationsItem.id}
          onClick={() => this.setActive(recommendationsItem)}
        />
